...
public class JSFEndPointAnalyzerTest {
    ...
    public void setUp() {
        ...
        lifecycleExecuteOp = new Operation().type(LifecycleExecuteOperationCollectionAspect.TYPE);
    }
    ...
    public void locateEndPoint() {
    	lifecycleExecuteOp.label("com.sun.faces.lifecycle.LifecycleImpl")
            .sourceCodeLocation(new SourceCodeLocation("com.sun.faces.lifecycle.LifecycleImpl", "execute", 111));
        FrameBuilder b = new SimpleFrameBuilder();
        Operation httpOp = new Operation().type(OperationType.HTTP);
        b.enter(httpOp);
        b.enter(lifecycleExecuteOp);
        ...
        assertEquals("com.sun.faces.lifecycle.LifecycleImpl.execute", endPoint.getEndPointName().getName());
