...
/**
 * This test verifies that {@link FacesValidator} is correctly
 * captured by the aspect,
 * {@link FacesValidatorOperationCollectionAspect}.
 */
public class FacesValidatorOperationCollectionAspectTest extends
	...
	public void myOperationCollected() {
		 ...
		 */
		assertEquals(MockValidator.class.getName(), op.getSourceCodeLocation().getClassName());
